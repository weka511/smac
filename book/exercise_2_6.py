...
'''
    ...
    periodic boundary conditions, for different covering densities. Run until we have
    a high quality histogram of x-values. Confront with data from exercose 2.3.
'''
