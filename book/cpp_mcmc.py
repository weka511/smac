...
def parse_arguments():
    ...
    parser.add_argument('--seed',type=int,default=None,help='Seetd for random number generator')
        ...
        for line in input_file:
            ...
            match (state):
                ...
                case 3:
                    ...
                    except ValueError:#beta=0.3333, acceptance=43.326%
                        match = pattern2.match(line)
                        accept = float(match.group(1))
...
if __name__=='__main__':
    ...
    m,n,periodic,beta,E,M,accept = read_file(args.path,args.input)
